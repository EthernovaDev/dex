        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search NovaDEX pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
      ...
      <Menu hide={!showMenu} ref={menuRef}>
        ...
        <div>
          ...
          {filteredPairList &&
            filteredPairList.slice(0, pairsShown).map((pair) => {
              ...
              updateNameData(pair)
              return (
              <BasicLink to={'/pair/' + pair.id.toLowerCase()} key={pair.id} onClick={onDismiss}>
                  <MenuItem>
        ...
        <div>
          ...
          {filteredTokenList.slice(0, tokensShown).map((token) => {
            ...
            return (
              <BasicLink to={'/token/' + token.id.toLowerCase()} key={token.id} onClick={onDismiss}>
                <MenuItem>
                  <RowFixed>
