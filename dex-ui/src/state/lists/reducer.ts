...
import { CHAIN_ID, TONY_ADDRESS, WNOVA_ADDRESS } from '../../constants/addresses'
...
const ETHERNOVA_FALLBACK_LIST: TokenList = {
  name: 'Ethernova Default',
...
const initialState: ListsState = {
  ...
  byUrl: {
    ...
    [DEFAULT_TOKEN_LIST_URL]: {
      error: null,
      current: ETHERNOVA_FALLBACK_LIST,
      loadingRequestId: null,
      pendingUpdate: null
    }
  },
