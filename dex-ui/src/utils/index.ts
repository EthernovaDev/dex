...
import { LIQUIDITY_ROUTER_ADDRESS, SWAP_ROUTER_ADDRESS } from '../constants'
...
export function getEtherscanLink(chainId: ChainId, data: string, type: 'transaction' | 'token' | 'address'): string {
  const base = EXPLORER_URL ? EXPLORER_URL.replace(/\/+$/, '') : `https://${ETHERSCAN_PREFIXES[chainId] || ETHERSCAN_PREFIXES[1]}etherscan.io`
