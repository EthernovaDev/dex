...
import { JSBI, Token, TokenAmount, Fraction, Percent, CurrencyAmount } from '@im33357/uniswap-v2-sdk'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${wrapped && token.equals(wrapped) ? 'WNOVA' : token.symbol}/NOVA V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your legacy V1 ${
          chainId && WRAPPED_NATIVE[chainId] && token.equals(WRAPPED_NATIVE[chainId]) ? 'WNOVA' : token.symbol
        }/NOVA liquidity will be redeemed for underlying assets.`}
      </TYPE.darkGray>
    </AutoColumn>
  )
}
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text="Remove your legacy V1 liquidity tokens." />
          </div>
        </AutoRow>
